...
const DEFAULT_HOUR_PLACEHOLDER = '';
const DEFAULT_MINUTE_PLACEHOLDER = '';
const DEFAULT_SECOND_PLACEHOLDER = '';
 ...
 * @docs-private
 */
let NgxMatMultiYearView = class NgxMatMultiYearView {
...
NgxMatCalendarHeader = __decorate([
    ...
    __param(1, Inject(forwardRef(() => NgxMatCalendar))),
    __param(2, Optional()),
...
let NgxMatTimepickerModule = class NgxMatTimepickerModule {
};
...
let NgxMatNativeDateAdapter = class NgxMatNativeDateAdapter extends NgxMatDateAdapter {
 ...
 * found in the LICENSE file at https://angular.io/license
 */
let NgxNativeDateModule = class NgxNativeDateModule {
};
...
let NgxMatNativeDateModule = class NgxMatNativeDateModule {
};
